...
images_p5 = [
    ...
    (r'(<h2.*?>第四章：威廉大院長的天文博雅教育與「希爾紹建築學派」的羅馬式巔峰</h2>)', 'images/hirsau_bausubstanz_map.jpg', '希爾紹修道院大教堂建築年代與地基結構分佈圖，完美體現了威廉大院長將幾何比例與宇宙秩序無縫轉化為石造空間的卓越才華'),
    (r'(<h3.*?>聖彼得與保羅修道院大教堂的興建</h3>)', 'images/hirsau_cubic_capitals.jpg', '聖奧雷利烏斯教堂內的羅馬式骰子柱頭，其上帶有希爾紹建築學派極具代表性的「希爾紹鼻」角狀突起特徵'),
    ...
    (r'(<h3.*?>文藝復興狩獵小屋的興建：權力的世俗化展示</h3>)', 'images/hirsau_hunting_lodge.jpg', '文藝復興式狩獵小屋與門塔廢墟，由符騰堡公爵在16世紀末建造，展現了世俗新教權力對前天主教修道院教產的接管與主權宣示'),
...
html_body_p22 = process_markdown(file_p22, images_p22, "1.4", map_p22, page_id="page22")
...
# [2026-08-08 移除] 舊版 template.html (87.7 KB) 讀取與 final_html 組裝邏輯。
# 該邏輯原用於產出 index_static.html，但該檔案已於 2026-07-19 廢棄，
# 主入口 index.html 改由 index_db.html 動態複製與注入索引。
# 故此處完全跳過 template.html 讀取以提升建置效能與節省記憶體。
